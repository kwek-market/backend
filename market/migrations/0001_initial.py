# Generated by Django 3.1.7 on 2021-12-03 09:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_query_name='product_rating', to='market.product')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_query_name='promo', to='market.product')),
            ],
        ),
        migrations.CreateModel(
            name='ProductOption',
            fields=[
                ...
                ('product', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_query_name='options', to='market.product')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image', to='market.product')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
